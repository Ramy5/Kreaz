  ...
  return (
    <div className="col-span-2 xl:col-span-3">
      ...
      <div className="flex justify-between w-full">
        ...
        <p className="bg-mainColorLight py-2 px-8 text-white rounded-full">
          <span className="text-2xl font-bold ">325</span> جنية
        </p>
      </div>

      {/* DESCRIPTION TEXT */}
      <p className="w-8/12  py-8 border-b border-gray-200 text-mainColorLight text-lg">
      ...
      {/* DESCRIPTION TEXT 2 */}
      <div className="w-8/12  py-3 border-t border-gray-200">
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex items-center gap-6">
          <span className="text-mainColorLight text-lg font-bold">الكمية</span>
