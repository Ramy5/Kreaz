    ...
    <div>
      {isAvailable && (
        ...
        >
          ...
          <span>اضف الي السله</span>
        </Link>
      )}

      {!isAvailable && (
        <p
          className={`bg-grayColorLight text-white px-2 py-2 flex items-center gap-2`}
        >
          <span className={`text-[12px]`}>عفوا المنتج غير متوفر للطلب</span>
        </p>
      )}
    </div>
  );
