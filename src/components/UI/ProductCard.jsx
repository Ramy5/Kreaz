...
const ProductCard = ({
  ...
  return (
    <>
      <Link
        href={cardLink}
        className="p-6 shadow-lg hover:scale-105 transition-all duration-300 hover:shadow-xl bg-white border border-gray-300 "
      >
        {/* IMAGE */}
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <AddCartAmount isAvailable={isAvailable} />
        </div>
      </Link>
    </>
  );
